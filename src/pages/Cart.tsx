      ...
      <Layout>
        <div className="flex flex-col items-center justify-center px-4 py-20">
          ...
          <button
            ...
            className="bg-surface-900 text-white px-6 py-3 rounded-xl font-semibold text-sm active:scale-95 transition-transform"
          >
            {t('catalog')}
          </button>
        </div>
        ...
        <div className="space-y-2.5 pb-36">
          {items.map((item) => (
            <div
              ...
              className="bg-white dark:bg-surface-800 rounded-xl p-3 shadow-sm"
            >
          ...
          <div className="bg-white dark:bg-surface-800 rounded-2xl p-5 w-full max-w-xs shadow-xl">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-2.5 rounded-xl bg-surface-900 text-white text-sm font-medium active:scale-95 transition"
              >
                {t('delete')}
              </button>
            </div>
