...
import { Gift, Star, ChevronRight, Sparkles, TrendingUp, Shield, Truck } from 'lucide-react';
import { useCreateReferral, useUserReferrals, useProducts, useBanners } from '../lib/supabase/hooks';
            ...
            {user && userReferrals.length > 0 && (
              <div className="mb-8 animate-fade-in-up stagger-4">
                <button
                  ...
                  className="w-full bg-white/6 hover:bg-white/10 backdrop-blur-sm text-white/80 py-3 px-4 rounded-xl font-medium transition-colors flex items-center justify-center gap-2 text-sm border border-white/6 hover:border-white/12"
                >
                ...
                {showReferral && (
                  <div className="mt-3 bg-white rounded-2xl p-4 shadow-float animate-scale-in">
