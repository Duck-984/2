  ...
  return (
    <Layout>
      <div className="px-4 pt-5 pb-2">
        <h1 className="text-xl font-bold text-surface-900" style={{ letterSpacing: '-0.01em' }}>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            <div
              ...
              style={{ background: '#F3EDE4', border: '1px solid #E6DED3' }}
            >
              <Heart className="w-9 h-9" style={{ color: '#D5C9BC' }} />
            </div>
            ...
            <button
              ...
              className="px-6 h-12 rounded-xl text-sm font-semibold transition-all duration-150 active:scale-95"
